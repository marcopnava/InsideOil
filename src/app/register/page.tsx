    ...
    <div className="relative z-10 w-full max-w-[380px]">
      <div className="text-center mb-8">
        ...
        <p className="text-[13px] text-white/50">
          {plan ? "Create your account to start your plan" : "Create your account"}
        </p>
      </div>
      ...
      <p className="text-center text-[11px] text-white/40 mt-5">
        ...
        <a href={plan ? `/login?callbackUrl=/api/checkout?plan=${plan}` : "/login"} className="text-accent font-semibold no-underline hover:underline">Sign in</a>
      </p>
    </div>
  );
}
